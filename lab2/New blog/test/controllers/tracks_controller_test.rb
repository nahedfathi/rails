...
class TracksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create track" do
    assert_difference("Track.count") do
      post tracks_url, params: { track: { description: @track.description, name: @track.name } }
    end
  ...
  test "should update track" do
    patch track_url(@track), params: { track: { description: @track.description, name: @track.name } }
